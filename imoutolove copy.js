...
const _0L0_ = {
    ...
    init: function () {
        ...
        //屏蔽脚本的配置按钮
        let blockConfigRoot = document.querySelector("a.link5:nth-child(2)").parentElement;
        if (blockConfigRoot) {
            _0L0_.createConfigBTN(blockConfigRoot);
        }
    ...
    createConfigBTN: (blockConfigRoot) => {
        ...
        container.innerHTML = `<a href="javascript:void(0);" id="myConfig">
                                    屏蔽配置
        ...
        //将新创建的屏蔽元素按钮追加到合适的位置！
        blockConfigRoot.appendChild(container.firstChild); delete container;
        let configBTN = blockConfigRoot.lastElementChild;
